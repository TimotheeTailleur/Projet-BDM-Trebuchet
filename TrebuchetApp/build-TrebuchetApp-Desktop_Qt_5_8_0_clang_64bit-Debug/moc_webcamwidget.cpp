...
#include "../TrebuchetApp/webcamwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WebcamWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WebcamWidget_t qt_meta_stringdata_WebcamWidget = {
    {
QT_MOC_LITERAL(0, 0, 12), // "WebcamWidget"
QT_MOC_LITERAL(1, 13, 6), // "update"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "WebcamWidget\0update\0"
};
...
void WebcamWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WebcamWidget *_t = static_cast<WebcamWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject WebcamWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WebcamWidget.data,
      qt_meta_data_WebcamWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WebcamWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WebcamWidget.stringdata0))
